 ...
 * 22 nov. 06
 */
public class MaabacStateV2 extends AbstractState {
    ...
    public MaabacStateV2(IEnvironment ct){
	super(ct); 
    ...
    public MaabacStateV2(IEnvironment ct,int t){
	super(ct); 
	this.taille=t; 
	this.contractionValues=new int[this.taille];
	this.maxValues=new int[this.taille]; 
    ...
    public void changeValue(int i,MuscleNullableAction a){
    ...
    public double getDdir(){return this.direction;}
     ...
     /** Clone */
    public IState copy(){
	MaabacStateV2 neuf=new MaabacStateV2(myEnvironment,this.taille); 
	...
	if(!(o instanceof MaabacStateV2)) return false; 
	MaabacStateV2 ms=(MaabacStateV2)o; 
