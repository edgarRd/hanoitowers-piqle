 ...
 * 23 nov. 06
 */
abstract public class AbstractMemberV2 extends AbstractEnvironmentSingle{
...
/** A (abstract) member is an assembly of muscles, with one free end (the member position), 
    ...
    protected MaabacStateV2 defaultInitialState; 
    ...
    public AbstractMemberV2(){}

    public AbstractMemberV2(double x,double y,double r){}
