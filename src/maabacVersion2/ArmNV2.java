...
public class ArmNV2  extends AbstractMemberV2{
    ...
    public ArmNV2(int segments,double x,double y,double r){
	this(segments); 
	this.xTarget=x; 
	this.yTarget=y; 
	this.rTarget=r; 
 ...
 // Graphical Interface
    ...
    protected ArmNDesignV2 designArea; 
	...
	designArea=new ArmNDesignV2((taille+2)*50,(taille+2)*50); 
