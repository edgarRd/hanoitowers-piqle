...
public class Contraction extends AbstractState{
    ...
    public Contraction(IEnvironment ct){
	super(ct); 
    }

    public Contraction(IEnvironment ct,int val,int maxv,int d1,int d2,
    ...
    public IState copy(){
	Contraction c=new Contraction(myEnvironment,this.value,this.maxValue,
